# Angular Boot Camp example: pipe-locales
...
**[StackBlitz for pipe-locales](https://stackblitz.io/github/AngularBootCamp/pipe-locales)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/pipe-locales.git
cd pipe-locales
npm install
npm start
```
